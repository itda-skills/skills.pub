...
name: realty-meta
description: >
  itda-realty-data 부동산 스킬팩의 색인·도움말 가이드입니다.
  "부동산 스킬 목록 보여줘", "itda-realty-data 도움말", "실거래가 스킬 뭐 있어"처럼 말하면 됩니다.
  사용 가능한 스킬·필요한 API 키·빠른 시작 예시를 안내합니다.
license: Apache-2.0
compatibility: "Claude Code & Cowork. Python 3.10+"
user-invocable: true
allowed-tools: Read
argument-hint: "부동산 스킬 목록 / itda-realty-data 도움말"
metadata:
