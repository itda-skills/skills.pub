...
사용 예 (저장소 루트 기준):
    python3 itda-realty-data/skills/court-auction/scripts/main.py codes courts
    python3 itda-realty-data/skills/court-auction/scripts/main.py notices --date 2026-04 --court-code B000210
    python3 itda-realty-data/skills/court-auction/scripts/main.py case --court-code B000210 --case-number 2024타경100001
    python3 itda-realty-data/skills/court-auction/scripts/main.py search --sido 서울특별시 --usage-large 건물 --price-max 500000000
