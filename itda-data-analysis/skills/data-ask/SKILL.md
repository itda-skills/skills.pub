...
itda-data-analysis 데이터 양심 vertical(정리 `data-prep` · 질문 `data-ask`)의 질문 담당.
(SPEC-DATA-VERTICAL-001, itda-data-analysis. 구 `data-query-runner`·`data-analysis-advisor` 흡수)
