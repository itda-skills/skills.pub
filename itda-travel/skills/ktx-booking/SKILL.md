...
PYTHONPATH=shared python3 itda-travel/skills/ktx-booking/scripts/main.py search --dep 서울 --arr 부산 --date 20260612 --time 140000
PYTHONPATH=shared python3 itda-travel/skills/ktx-booking/scripts/main.py reserve --dep 서울 --arr 부산 --date 20260612 --time 140000 --index 0            # 미리보기(예약 안 함)
PYTHONPATH=shared python3 itda-travel/skills/ktx-booking/scripts/main.py reserve --dep 서울 --arr 부산 --date 20260612 --time 140000 --index 0 --confirm  # 실제 예약
PYTHONPATH=shared python3 itda-travel/skills/ktx-booking/scripts/main.py reservations

# Windows
$env:PYTHONPATH="shared"; py -3 itda-travel/skills/ktx-booking/scripts/main.py search --dep 서울 --arr 부산
```
