...
PYTHONPATH=shared python3 itda-travel/skills/train-srt/scripts/main.py search --dep 수서 --arr 부산 --date 20260612 --time 180000
PYTHONPATH=shared python3 itda-travel/skills/train-srt/scripts/main.py reserve --dep 수서 --arr 부산 --date 20260612 --time 180000 --index 0            # 미리보기(예약 안 함)
PYTHONPATH=shared python3 itda-travel/skills/train-srt/scripts/main.py reserve --dep 수서 --arr 부산 --date 20260612 --time 180000 --index 0 --confirm  # 실제 예약
PYTHONPATH=shared python3 itda-travel/skills/train-srt/scripts/main.py reservations

# Windows
$env:PYTHONPATH="shared"; py -3 itda-travel/skills/train-srt/scripts/main.py search --dep 수서 --arr 부산
```
