...
> **⚠️ 네이버 신규 발급 안내 (2026-07-31부터)**: 네이버가 검색 API를 네이버클라우드의 **NAVER API HUB**로 옮기고 있어요. 2026-07-30까지는 위 방법대로 발급되지만, 그 이후에 새로 발급하려면 NAVER API HUB에서 신청해야 합니다. 이미 받은 키는 2027-06-30까지 그대로 동작합니다.
