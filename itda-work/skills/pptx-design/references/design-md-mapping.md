...
> **먼저 `../../design-core/library/` 를 확인하라** — 아래 팔레트 중 6종(컨설팅·트레이딩 다크·에디토리얼·신문·테크 다크·미니멀)은 슬라이드 문법 레시피까지 갖춘 **ready-to-use DESIGN.md 프리셋**으로 승격돼 있다(#303). 톤 키워드가 있으면 프리셋을 통째로 적용하는 쪽이 우선이고, 아래 표는 프리셋에 없는 톤을 조합할 때 쓴다.
