#!/usr/bin/env python3
"""itda-calendar: check_connection.py — live principal/calendar discovery test."""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Test CalDAV connection.")
    ...
    emit({
        ...
        "principal": str(principal.url),
        "calendar_count": len(cals),
        "calendars": [{"name": c["name"], "components": c["components"]} for c in cals],
    })
