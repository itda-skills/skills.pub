...
| 스킬 | 설명 | 환경 |
|------|------|:----:|
| **itda-work-find** | 비개발자 직장인의 업무 자동화·문제해결 후보를 단계별 인터뷰로 발굴 (트랙 A 반복 업무 / 트랙 B 미지의 문제) | 📦 |
| **itda-work-plan** | 사용자 요청을 적합한 itda-* 스킬 조합으로 매핑해 실행 계획 한 장 메모 출력 (미러백 + ground-check 검증) | 📦 |
