...
출처: https://opendart.fss.or.kr/guide/detail.do?apiGrpCd=DS005&apiId=2020043
추출일: 2026-04-28
...
|------|------|
| 메서드 | GET |
| JSON URL | https://opendart.fss.or.kr/api/bsnTrfDecsn.json |
| XML URL | https://opendart.fss.or.kr/api/bsnTrfDecsn.xml |
| 인코딩 | UTF-8 |
