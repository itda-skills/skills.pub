...
description: >
  ...
  환율은 itda-day-organize:exchange-rate 가 맡습니다.
license: Apache-2.0
...
기본 출력은 **compact JSON**(itda-gov-collect 팩 관례) — 필드(`series`·`latest_price`…)와 함께 표시용 완성 문자열
...
| 환율·원자재 시황 | itda-day-organize:exchange-rate · itda-gov-collect:ecos |
