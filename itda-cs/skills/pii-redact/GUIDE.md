...
**`/pii-redact 지침`으로 부탁하면 됩니다** — `/pii-redact 이 상담 로그 비식별화해줘`처럼요.
...
| 하고 싶은 것 | 이렇게 요청하세요 |
|---|---|
| 로그 비식별화 | `/pii-redact 이 상담 로그 비식별화해줘` |
| 개인정보 가리기 | `/pii-redact 개인정보 가려줘` |
| 익명화 | `/pii-redact 이거 안전하게 익명화해줘` |
| PII 마스킹 | `/pii-redact PII 마스킹해줘` |
