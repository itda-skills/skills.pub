...
description: >
  ...
  [책임 경계] 본 스킬은 정적 페이지 단건 페치·추출 전담 — 네이버 블로그는 itda-web-collect:blog-reader, 키워드 검색은 itda-web-collect:web-search, JS 렌더·로그인·차단 우회는 itda-web-collect:web-automation.
license: Apache-2.0
...
| 키워드로 URL 찾기 | itda-web-collect:web-search |
| JavaScript 렌더·로그인 세션·봇 차단 우회 | itda-web-collect:web-automation |
| 사이트를 정찰해 등급·플레이북 만들기 | itda-web-collect:web-scout |
