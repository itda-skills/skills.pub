...
description: >
  ...
  papercraft PDF 도안으로 만듭니다. 전개도·풀 날개·A4 배치·기하 검증·조립 순서·완성 조감도(3D 렌더)까지 한 번에.
  "페이퍼크래프트 만들어줘", "종이접기 도안", "크리퍼 papercraft pdf", "아이랑 만들 종이 로봇", "전개도 뽑아줘",
  "이 papercraft 조립 되는지 검토해줘"처럼 말하면 사용하세요.
  [책임 경계] 상자 조합 papercraft 전개도 PDF 전담 — 도트 그림 변환은 itda-family-play:pixel-art, 새 그림 생성은 itda-content-create:imagegen.
license: Apache-2.0
