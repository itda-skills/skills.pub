...
실행 전제: shared/ 모듈을 import 하므로 ``PYTHONPATH=skills/shared`` 가 필요하다.
  예: PYTHONPATH=skills/shared python3 skills/itda-travel-plan/skills/train-ktx/scripts/main.py search ...
공통 CLI 코어는 train_cli.py(정본 itda-travel-plan/shared/, scripts/ 벤더링 사본)가 담당한다.
"""
