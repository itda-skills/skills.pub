...
사용 예 (저장소 루트 기준):
    python3 skills/itda-travel-plan/skills/place-finder/scripts/main.py search --near 강남역 --category 술집
    python3 skills/itda-travel-plan/skills/place-finder/scripts/main.py search --near 홍대입구역 --category 카페 --amenity wifi --json
