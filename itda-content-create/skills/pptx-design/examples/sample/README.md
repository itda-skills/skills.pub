...
python3 skills/itda-content-create/skills/pptx-design/examples/sample/gen.py
...
# macOS/Linux
cd /Users/allieus/Apps/itda-skills/hyve
python3 skills/itda-content-create/skills/pptx-design/scripts/verify.py \
  skills/itda-content-create/skills/pptx-design/examples/sample/deck.pptx \
  --tokens <(printf "삼성전자\n하이닉스\n목표주가\n") --ko "삼성전자,하이닉스"
```
