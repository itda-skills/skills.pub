...
description: >
  ...
  [책임 경계] 본 스킬은 초안 생성 전담(AI 흔적 사전의 정본: itda-content-create:human-tone) — 이미 작성된 글의 AI 흔적 제거·문체 후처리는 itda-content-create:human-tone 이 맡고, 본 스킬은 발행·송부를 하지 않습니다.
license: Apache-2.0
...
| 상황 | 대신 쓸 스킬 |
|---|---|
| 이미 작성된 글의 AI 흔적 제거·문체 다듬기 | itda-content-create:human-tone |
| 네이버 블로그 키워드 선정(초안 앞 단계) | itda-content-create:blog-seo |
| 주장·수치의 출처 검증 | itda-evidence-verify:ground-check |
| 완성 문서를 docx/pptx/hwpx 로 조판 | itda-content-create:docx-design · itda-content-create:pptx-design · itda-content-create:hwpx |
| 메일 발송 | itda-day-organize:email |
