...
description: >
  ...
  [책임 경계] 본 스킬은 보고서형 HTML 렌더 전담 — 아침 브리핑 페이지는 itda-day-organize:morning-brief.
license: Apache-2.0
...
| 상황 | 대신 쓸 스킬 |
|---|---|
| "아침 브리핑 보여줘", 캘린더·메일에서 수집해 하루 한 장 페이지로 | itda-day-organize:morning-brief |
| 워드·PPT 산출이 필요할 때 | itda-content-create:docx-design · itda-content-create:pptx-design |
