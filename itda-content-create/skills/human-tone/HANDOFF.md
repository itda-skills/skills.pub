...
> 이 문서는 차기 Claude Code 세션이 `../skills/itda-work` (또는 `skills/itda-content-create/skills/human-tone`)에서 작업을 이어받기 위한 self-contained 가이드.
...
**인수인계 컨텍스트 손실 시 복구 경로**: `ref-cowork-plugins/KNOWLEDGE.md`에 cowork-plugins 노하우, 본 HANDOFF.md에 human-tone 진행 상태가 모두 기록됨.
...
- **인수인계 컨텍스트**: ref-cowork-plugins 디렉토리에서 진행한 대화 (KNOWLEDGE.md 직전)
...
| cowork-plugins (humanize-korean Fast 변형) | `/Users/allieus/Apps/itda-skills/ref-cowork-plugins/content/skills/humanize-korean/` | Fast 변형 패턴 재참조 |
| cowork-plugins KNOWLEDGE.md | `/Users/allieus/Apps/itda-skills/ref-cowork-plugins/KNOWLEDGE.md` | cowork 컨벤션 일반론 |
