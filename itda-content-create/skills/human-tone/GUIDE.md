...
**Claude에게 말로 부탁하면 됩니다** — `/human-tone 이 보고서 AI 같아, 사람이 쓴 것처럼 고쳐줘`처럼요. 자연어로 말해도 그대로 동작합니다 — `/human-tone` 접두는 생략 가능합니다.
...
무엇이 바뀌었는지 라인 단위로 비교하고 싶을 때는 `/human-tone 변경된 부분만 보여줘`라고 말하세요.
